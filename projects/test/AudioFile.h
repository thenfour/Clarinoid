...
bool AudioFile<T>::decodeAiffFile (std::vector<uint8_t>& fileData)
{
    ...
    uint16_t numChannels = twoBytesToInt (fileData, p + 8, Endianness::BigEndian);
    uint32_t numSamplesPerChannel = fourBytesToInt (fileData, p + 10, Endianness::BigEndian);
    ...
    size_t numBytesPerFrame = numBytesPerSample * numChannels;
