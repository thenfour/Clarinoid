...
struct TestDeviceApp : ISysInfoProvider
{
  ...
  virtual uint8_t ISysInfoProvider_GetPolyphony() override { return 0; }
  virtual float ISysInfoProvider_GetAudioCPUUsage() override { return AudioProcessorUsage(); }
  ...
  virtual MidiNote ISysInfoProvider_GetNote() override { return MidiNote(4, millis() / 600 % 12); }
  virtual float ISysInfoProvider_GetTempo() override { return mMusicalStateTask.mMetronome.mBPM; }
  virtual Metronome* ISysInfoProvider_GetMetronome() override { return &mMusicalStateTask.mMetronome; }
  virtual float ISysInfoProvider_GetPitchBendN11() override { return 0; }
  virtual float ISysInfoProvider_GetBreath01() override { return 0; }
  virtual AppSettings* ISysInfoProvider_GetSettings() override { return &mAppSettings; }
  ...
  void Main()
  {
    ...
    IDisplayApp* allApps[] = {
      ...
      &mGuiTestApp,           &mGuiPerformanceApp,

      &mPerfPatchApp,         &mHarmPatchApp,      &mSynthPatchApp,
