...
namespace clarinoid
{
    ...
    struct PerformanceApp : SettingsMenuApp
    {
        ...
        PerformanceApp(CCDisplay &d, MusicalStateTask *pMusicalStateTask, BassoonoidControlMapper *controls) : SettingsMenuApp(d),
    ...
    struct DebugDisplayApp : SettingsMenuApp
    {
        ...
        DebugDisplayApp(CCDisplay &d, BassoonoidControlMapper &c, MusicalStateTask &mst) : SettingsMenuApp(d),
                                                                                           mControls(c),
