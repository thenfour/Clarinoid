...
{
  if (in <= 1u) return in; // 0->0, 1->1
  uint32_t n = sqrt_integer_guess_table[clz32(in)];
...
static uint32_t sqrt_Q32_to_Q16_NR_wrap(uint32_t X){ return sqrt_Q32_to_Q16_NR(X); }
static uint32_t sqrt_q32_rest_wrap(uint32_t X)     { return sqrt_qF_restoring<32>(X); }
static uint32_t sqrt_q24_rest_wrap(uint32_t X)     { return sqrt_qF_restoring<24>(X); }
static uint32_t sqrt_q32_float_wrap(uint32_t X)    { return sqrt_qF_float<32>(X); }
static uint32_t sqrt_q24_float_wrap(uint32_t X)    { return sqrt_qF_float<24>(X); }
static uint32_t sqrt_q32_vsqrt32_wrap(uint32_t X)    { return sqrt_qF_vsqrt32<32>(X); }
static uint32_t sqrt_q24_vsqrt32_wrap(uint32_t X)    { return sqrt_qF_vsqrt32<24>(X); }
