...
//   TriggerSettingItem mClearAll = { "Clear All", [](void*){ gMusicalState.mLooper.Clear(); }, nullptr, AlwaysEnabled };
//   TriggerSettingItem mLoopIt = { "Loop it", [](void*){ gMusicalState.mLooper.LoopIt(gMusicalState.mLiveVoice); }, nullptr, AlwaysEnabled };

//   LabelSettingItem mStatus = { []() {return (String)(String("Status:") + (int)gMusicalState.mLooper.mStatus.mState); }, AlwaysEnabled };
//   LabelSettingItem mLayer = { []() {return (String)(String("Layer:") + gMusicalState.mLooper.mCurrentlyWritingLayer); }, AlwaysEnabled };
//   LabelSettingItem mLoopTime = { []() {return (String)(String("LoopTimeMS:") + gMusicalState.mLooper.mStatus.mCurrentLoopTimeMS); }, [](){ return gMusicalState.mLooper.mStatus.mState == LooperState::StartSet; } };
//   LabelSettingItem mLoopLen = { []() {return (String)(String("LoopLengthMS:") + gMusicalState.mLooper.mStatus.mLoopDurationMS); }, [](){ return gMusicalState.mLooper.mStatus.mState == LooperState::DurationSet; } };
//   //LabelSettingItem mLoopPolyphony = { []() {return String("LoopPoly :") + gMusicalState.mLooper.mCurrentPolyphony; }, AlwaysEnabled };
...
//   TriggerSettingItem mLayer1Clear = { " > Clear", [](void*){ gMusicalState.mLooper.ClearLayer(0); }, nullptr, AlwaysEnabled };
...
//   TriggerSettingItem mLayer2Clear = { " > Clear", [](void*){ gMusicalState.mLooper.ClearLayer(1); }, nullptr, AlwaysEnabled };
...
//   TriggerSettingItem mLayer3Clear = { " > Clear", [](void*){ gMusicalState.mLooper.ClearLayer(2); }, nullptr, AlwaysEnabled };
