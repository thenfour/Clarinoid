...
struct MPR121Device
{
  ...
  void SoftReset() { begin(mI2caddr, mTheWire, mTouchThreshold, mReleaseThreshold, mElectrodesInUse, mAutoconfig); }
   ...
   * release)
   */
  void setThreshholds(uint8_t touch, uint8_t release) { setThresholds(touch, release); }
