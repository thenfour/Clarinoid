...
// // we are polyphonic so you may need to throw out up to MAX_MUSICAL_VOICES number of voices if they are found to be too
// // short.
...
//     int mPlayingRefs =
//         0; // when this rises from 0, mNoteDurationTimer engages. When it drops to 0, mNoteOffTimer engages.
...
//     void UpdateWithVoice(const HeldNoteInfo &mv)
//     {
//         mTouched = true;
//         if (mv.IsPlaying())
//         {
...
//             mIsTransient =
//                 mNoteDurationTimer.ElapsedTime().ElapsedMillisI() < SCALE_FOLLOWER_TRANSIENT_NOTE_THRESH_MILLIS;
//         }
