...
namespace clarinoid
{
  namespace filters
  {
    struct DiodeFilter : public IFilter
    {
      ...
      // IFilter
      virtual void SetType(FilterType type) override {} // only lowpass supported
    ...
    private:
      ...
      inline real InlineProcessSample(real xn)
      {
        ...
        real output = m_LPF4.InlineProcessSample(m_LPF3.InlineProcessSample(m_LPF2.InlineProcessSample(m_LPF1.InlineProcessSample(u))));
