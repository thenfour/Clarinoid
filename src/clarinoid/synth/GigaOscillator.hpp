...
//     //     // return WVShape{
//     //     //     .mSegments = {
//     //     //         WVSegment{.beginPhase01 = 0.0, .endPhaseIncluding1 = dutyCycle01, .beginAmp = -1.0f, .slope =
//     0},
//     //     //         WVSegment{.beginPhase01 = dutyCycle01, .endPhaseIncluding1 = 1.0, .beginAmp = 1.0f, .slope =
//     0},
//     //     //     }};
//     // }
