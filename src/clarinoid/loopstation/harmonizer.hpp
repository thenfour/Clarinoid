...
struct Harmonizer
{
    ...
    void HarmonizeNoteOn(const MusicalVoice &srcVoice,
                     HarmPreset &preset,
                     VoiceFilterOptions voiceFilter)
    {
        ...
        //     pout->mVoiceId = MakeMusicalVoiceID(loopLayerID, HarmLayerToVoiceID((uint8_t)nVoice));
        ...
        //         pout->mSynthPatchA = perf.mSynthPresetA;
        //         break;
        //     case HarmSynthPresetRefType::GlobalB:
        //         pout->mSynthPatchA = perf.mSynthPresetB;
        //         break;
